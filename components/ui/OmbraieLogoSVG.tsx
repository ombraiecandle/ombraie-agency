...
export default function OmbraieLogoSVG({ size = 40, showText = true, className = "" }: LogoProps) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        {/* Shadow cast — bottom-right */}
        <ellipse cx="52" cy="60" rx="22" ry="6" fill="url(#shadowGrad)" opacity="0.7" />

        {/* Outer ring — broken/shadow */}
        <circle
          cx="36"
          cy="36"
          r="28"
        ...
        {/* Inner hexagon */}
        <polygon
          points="36,14 54,24 54,44 36,54 18,44 18,24"
          fill="none"
          stroke="url(#logoGrad1)"
          strokeWidth="1.5"
          opacity="0.5"
        ...
        {/* Diamond center */}
        <polygon
          points="36,22 48,36 36,50 24,36"
          fill="url(#logoGrad1)"
          opacity="0.15"
        />
        <polygon
