...
const ads = [
  {
    ...
    period: "3 mois",
    metrics: [
      { label: "Retour pub", value: "4.8×", change: "+320%", up: true },
      { label: "Chiffre d'affaires", value: "+340%", change: "vs avant", up: true },
      { label: "Coût par clic", value: "0.42€", change: "-55%", up: false },
      { label: "Taux de clic", value: "3.2%", change: "+180%", up: true },
    ],
  ...
  },
  {
    ...
    period: "2 mois",
    metrics: [
      { label: "Retour pub", value: "4.2×", change: "+260%", up: true },
      { label: "Coût par client", value: "18€", change: "-62%", up: false },
      { label: "Nouveaux clients", value: "+180/mois", change: "+245%", up: true },
      { label: "Taux de conversion", value: "6.8%", change: "+3.2pts", up: true },
    ],
    chart: [22, 30, 38, 42, 55, 60, 68, 75, 80, 88, 94, 100],
    chartColor: "#34A853",
    tags: ["Recherche Google", "YouTube"],
  ...
  },
  {
    ...
    period: "2 mois",
    metrics: [
      { label: "Retour pub", value: "3.6×", change: "+210%", up: true },
      { label: "Ventes", value: "+280%", change: "en 60 jours", up: true },
      { label: "Coût pour 1000 vues", value: "8.50€", change: "-40%", up: false },
      { label: "Personnes touchées", value: "145K", change: "+320%", up: true },
    ],
    chart: [15, 25, 22, 38, 45, 52, 60, 68, 72, 85, 92, 100],
    chartColor: "#a855f7",
    tags: ["Acquisition", "Retargeting"],
