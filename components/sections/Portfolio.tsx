...
import { Check, TrendingUp, ArrowRight, MapPin, Phone } from "lucide-react";

// ─── DATA ────────────────────────────────────────────────────

const adCampaigns = [
  {
    client: "Boutique Mode", sector: "Vêtements · Toulouse",
    platform: "Facebook & Instagram Ads", duration: "3 mois · 800€/mois",
    metrics: [
      { label: "Impressions", value: "124 000" }, { label: "Clics",    value: "3 870"   },
      { label: "Taux de clic",value: "3,12%"   }, { label: "ROAS",     value: "4.8×"    },
      { label: "CA généré",   value: "22 400€" }, { label: "Coût/clic",value: "0,62€"   },
    ],
    bars: [30, 45, 38, 62, 78, 55, 82, 70, 85, 92, 80, 100],
    accent: "#7c3aed", roas_highlight: "4.8×", ca_highlight: "+22 400€",
  },
  {
    client: "Restaurant Le Gaulois", sector: "Restauration · Pamiers",
    platform: "Facebook Ads", duration: "6 semaines · 400€/mois",
    metrics: [
      { label: "Impressions", value: "42 000" }, { label: "Clics",    value: "1 240"  },
      { label: "Taux de clic",value: "2,95%"  }, { label: "ROAS",     value: "3.2×"   },
      { label: "CA généré",   value: "8 600€" }, { label: "Coût/clic",value: "0,77€"  },
    ],
    bars: [20, 32, 28, 50, 60, 45, 68, 58, 72, 78, 65, 84],
    accent: "#f59e0b", roas_highlight: "3.2×", ca_highlight: "+8 600€",
  },
  {
    client: "Coach Fitness Clara", sector: "Coaching · En ligne",
    platform: "Instagram & Google Ads", duration: "2 mois · 600€/mois",
    metrics: [
      { label: "Impressions", value: "89 000"  }, { label: "Clics",    value: "2 560"   },
      { label: "Taux de clic",value: "2,88%"   }, { label: "ROAS",     value: "5.4×"    },
      { label: "CA généré",   value: "15 700€" }, { label: "Coût/clic",value: "0,55€"   },
    ],
    bars: [38, 55, 50, 68, 76, 65, 82, 75, 90, 86, 93, 100],
    accent: "#34d399", roas_highlight: "5.4×", ca_highlight: "+15 700€",
  },
];
...
const websites = [
  {
    ...
    deliveryTime: "3 semaines", price: "1 200€",
  },
  {
    ...
    deliveryTime: "4 semaines", price: "2 400€",
  },
  {
    ...
    deliveryTime: "2 semaines", price: "950€",
  },
];
...
const flyers = [
  {
    ...
    prints: "500 ex.", deliveryTime: "5 jours", price: "220€",
  },
  {
    ...
    prints: "200 affiches", deliveryTime: "4 jours", price: "350€",
  },
  {
    ...
    type: "Flyer A4 Recto",
    color1: "#0369a1", color2: "#4338ca",
    prints: "1 000 ex.", deliveryTime: "3 jours", price: "200€",
  },
];
...
const adsPricing = [
  {
    name: "Starter", price: "300€", period: "/mois", sub: "Budget pub jusqu'à 500€/mois",
    features: ["Campagnes Facebook & Instagram", "Ciblage audience sur-mesure", "Rapport mensuel complet", "1 visuel publicitaire/semaine"],
  },
  {
    name: "Pro", price: "500€", period: "/mois", sub: "Budget pub 500€ – 2 000€/mois",
    features: ["Facebook, Instagram + Google Ads", "Remarketing & audiences similaires", "Rapport hebdo + appel bilan mensuel", "3 visuels/semaine"],
    highlighted: true,
  },
  {
    name: "Expert", price: "750€", period: "/mois", sub: "Budget pub 2 000€+/mois",
    features: ["Multi-plateforme (Meta, Google, TikTok)", "A/B testing continu", "Tableau de bord en temps réel", "Visuels & vidéos illimités"],
  },
];
const sitesPricing = [
  {
    name: "Site Vitrine", price: "800€", period: "", sub: "1 à 3 pages · Livré en 2-3 sem.",
    features: ["Design responsive mobile", "Formulaire de contact", "Google Maps intégré", "SEO de base inclus"],
  },
  {
    name: "Site Pro", price: "1 400€", period: "", sub: "5 à 8 pages · Livré en 3-4 sem.",
    features: ["Design premium sur-mesure", "Blog / page actualités", "SEO avancé + Analytics", "Prise de rendez-vous en ligne"],
    highlighted: true,
  },
  {
    name: "E-commerce", price: "1 500€", period: "", sub: "Boutique · Livré en 4 sem.",
    features: ["Jusqu'à 50 produits", "Paiement en ligne sécurisé", "Gestion des stocks", "Codes promo & livraison"],
  },
];
const flyersPricing = [
  {
    name: "Flyer A5", price: "150€", period: "", sub: "Recto · Livré en 3 jours",
    features: ["Création graphique complète", "1 révision incluse", "Fichier print-ready (PDF)", "Format réseaux offert"],
  },
  {
    name: "Flyer A5 R/V", price: "220€", period: "", sub: "Recto/Verso · Livré en 4 jours",
    features: ["Création graphique complète", "2 révisions incluses", "Fichiers print-ready", "Format réseaux offert"],
    highlighted: true,
  },
  {
    name: "Pack Complet", price: "450€", period: "", sub: "Flyer + Affiche + Réseaux",
    features: ["Tous formats (A5, A4, A3)", "Formats réseaux sociaux inclus", "Révisions illimitées", "Charte graphique incluse"],
  },
];
...
function AdCard({ c }: { c: typeof adCampaigns[0] }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-gray-100" style={{ background: "white", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
      <div className="px-5 py-4 flex items-center justify-between" style={{ background: c.accent }}>
        <div>
          <p className="text-white font-black text-base leading-tight">{c.client}</p>
      ...
      <div className="px-5 pt-5 pb-3">
        <p className="text-xs text-gray-400 font-medium mb-3">Évolution des performances · {c.duration}</p>
        <div className="flex items-end gap-1 h-14">
          {c.bars.map((h, i) => (
            <div key={i} className="flex-1 rounded-sm" style={{ height: `${(h / maxBar) * 100}%`, background: i === c.bars.length - 1 ? c.accent : `${c.accent}40` }} />
          ))}
        </div>
      </div>
      <div className="px-5 pb-5">
        ...
        <div className="flex gap-2 mt-3">
          <div className="flex-1 flex items-center gap-2 px-3 py-2 rounded-xl" style={{ background: `${c.accent}10`, border: `1px solid ${c.accent}25` }}>
            <TrendingUp size={13} style={{ color: c.accent }} />
            <span className="text-xs font-bold" style={{ color: c.accent }}>ROAS {c.roas_highlight}</span>
          </div>
          <div className="flex-1 flex items-center justify-center px-3 py-2 rounded-xl" style={{ background: `${c.accent}10`, border: `1px solid ${c.accent}25` }}>
            <span className="text-xs font-bold" style={{ color: c.accent }}>{c.ca_highlight} CA</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="rounded-2xl overflow-hidden border border-gray-100" style={{ background: "white", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
      ...
      <div className="px-3 py-2 flex items-center gap-2" style={{ background: "#f0f0ee", borderBottom: "1px solid #e5e5e3" }}>
        ...
        <div className="flex gap-1 ml-1">
          <div className="px-2 py-0.5 rounded-t text-[8px] text-gray-500 font-medium" style={{ background: "white", border: "1px solid #e5e5e3", borderBottom: "1px solid white" }}>
            {w.url.split(".")[0]}
          </div>
          <div className="px-2 py-0.5 rounded-t text-[8px] text-gray-400" style={{ background: "#e8e8e6" }}>+</div>
        </div>
      ...
      {/* Website miniature */}
      <div style={{ height: "270px", overflow: "hidden", position: "relative", fontSize: "0" }}>
        {/* NAV */}
        <div
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-4 h-4 rounded-sm flex items-center justify-center text-white text-[7px] font-black" style={{ background: w.accentColor }}>
              {w.name[0]}
            </div>
            <span className="text-[8px] font-black tracking-tight" style={{ color: w.navText }}>
          ...
          <div className="flex gap-2.5">
            {w.nav.slice(0, 3).map((item) => (
              <span key={item} className="text-[7px] font-medium" style={{ color: w.navText, opacity: 0.7 }}>{item}</span>
            ))}
          </div>
          {/* CTA */}
          <div className="px-2 py-0.5 rounded text-[7px] font-bold text-white" style={{ background: w.accentColor }}>
            {w.nav[3]}
          </div>
        </div>

        {/* HERO */}
        <div className="flex items-center justify-between px-4 py-4 gap-3" style={{ background: w.heroBg }}>
          <div className="flex-1">
            {/* Tag pill */}
            <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[7px] font-bold mb-2" style={{ background: `${w.accentColor}18`, color: w.accentColor }}>
              ✓ {w.heroTag}
            </div>
            {/* Headline */}
            <div className="font-black leading-[1.15] mb-2" style={{ fontSize: "12px", color: w.heroTextColor }}>
              {lines.map((l, i) => <div key={i}>{l}</div>)}
            </div>
            {/* Sub */}
            <div className="text-[7.5px] leading-relaxed mb-3" style={{ color: w.heroTextColor, opacity: 0.6, maxWidth: "130px" }}>
              {w.heroSub}
            </div>
            {/* CTA */}
            <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded text-[7px] font-bold text-white" style={{ background: w.accentColor }}>
              {w.heroCta}
            </div>
          </div>
          {/* Hero visual (fake image block) */}
          <div className="flex-shrink-0 w-20 h-20 rounded-xl flex items-center justify-center text-2xl" style={{ background: `linear-gradient(135deg, ${w.accentColor}25, ${w.accentColor}10)`, border: `1px solid ${w.accentColor}20` }}>
            {w.serviceIcons[0]}
          </div>
        </div>

        {/* SERVICES ROW */}
        <div style={{ background: "white", borderTop: "1px solid #f0f0f0", padding: "8px 12px" }}>
          <div className="text-[7px] font-bold uppercase tracking-wider mb-2" style={{ color: "#9ca3af" }}>
            {w.type === "E-commerce" ? "Nos produits" : "Nos prestations"}
          </div>
          <div className="grid grid-cols-3 gap-1.5">
            {w.services.map((s, i) => (
              <div key={s} className="rounded-lg overflow-hidden" style={{ border: `1px solid ${w.accentColor}15` }}>
                {/* Fake image */}
                <div className="flex items-center justify-center text-base" style={{ height: "30px", background: `linear-gradient(135deg, ${w.accentColor}12, ${w.accentColor}06)` }}>
                  {w.serviceIcons[i]}
                </div>
                <div style={{ padding: "4px 6px", background: "white" }}>
                  <div className="text-[7px] font-semibold text-gray-700 truncate">{s}</div>
                  {w.type === "E-commerce" && (
                    <div className="text-[7px] font-black mt-0.5" style={{ color: w.accentColor }}>
                      {["39€", "89€", "124€"][i]}
                    </div>
                  )}
                </div>
        ...
        {/* TESTIMONIAL STRIP */}
        <div className="flex items-center gap-2 px-3 py-2" style={{ background: `${w.accentColor}06`, borderTop: `1px solid ${w.accentColor}12` }}>
          <span className="text-[10px]">⭐⭐⭐⭐⭐</span>
          <span className="text-[7.5px] text-gray-500 italic truncate">&ldquo;{w.testimonial}&rdquo;</span>
        </div>
        ...
        <div className="flex items-center justify-between px-3 py-1.5" style={{ background: "#1a1a2e" }}>
          ...
          <span className="text-[7px] font-bold" style={{ color: w.accentColor }}>© 2025</span>
        </div>

        {/* Bottom fade */}
        <div className="absolute bottom-0 left-0 right-0 h-5 pointer-events-none" style={{ background: "linear-gradient(transparent, white)" }} />
      </div>
      ...
      <div className="px-5 py-4 border-t border-gray-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-xs mt-0.5">{w.sector} · {w.type}</p>
        </div>
        <div className="text-right">
          <p className="font-black text-sm" style={{ color: "#7c3aed" }}>{w.price}</p>
...
// ── FLYER 1 — Restaurant (chaleureux, brasserie) ────────────
function FlyerRestaurant({ f }: { f: typeof flyers[0] }) {
  return (
    <div style={{ aspectRatio: "1/1.41", position: "relative", overflow: "hidden", background: "#1a0800" }}>
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(160deg, #c2410c 0%, #92400e 50%, #1c0a00 100%)" }} />

      {/* SVG: concentric plate/sun rings — top right */}
      <svg style={{ position: "absolute", top: "-18%", right: "-18%", width: "72%", opacity: 0.18 }} viewBox="0 0 200 200">
      ...
      {/* SVG: small rings bottom left */}
      <svg style={{ position: "absolute", bottom: "12%", left: "-12%", width: "38%", opacity: 0.07 }} viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="48" stroke="white" strokeWidth="1.5" fill="none" />
        <circle cx="50" cy="50" r="34" stroke="white" strokeWidth="1" fill="none" />
        <circle cx="50" cy="50" r="18" stroke="white" strokeWidth="0.7" fill="none" />
      </svg>
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ textAlign: "center", padding: "16px 15px 12px", borderBottom: "1px solid rgba(255,255,255,0.09)" }}>
          ...
          {f.title.split("\n").map((line, i) => (
            <div key={i} style={{ color: i === 0 ? "rgba(255,255,255,0.9)" : "#f59e0b", fontSize: i === 0 ? "22px" : "30px", fontWeight: 900, lineHeight: 1.05, letterSpacing: i === 0 ? "4px" : "2px", textTransform: "uppercase", textShadow: "0 2px 16px rgba(0,0,0,0.5)" }}>
              {line}
            </div>
          ))}
...
// ── FLYER 2 — Studio Pilates (zen, mandala, violet) ──────────
function FlyerPilates({ f }: { f: typeof flyers[0] }) {
  ...
  return (
    <div style={{ aspectRatio: "1/1.41", position: "relative", overflow: "hidden", background: "#0f0428" }}>
      ...
      {/* SVG: lotus mandala — large, top center */}
      <svg style={{ position: "absolute", top: "4%", left: "50%", transform: "translateX(-50%)", width: "80%", opacity: 0.22 }} viewBox="0 0 200 200">
        ...
        {[22.5, 67.5, 112.5, 157.5, 202.5, 247.5, 292.5, 337.5].map((a) => (
          <line key={a} x1="100" y1="100" x2={100 + 95 * Math.cos(a * Math.PI / 180)} y2={100 + 95 * Math.sin(a * Math.PI / 180)} stroke="white" strokeWidth="0.25" />
        ))}
        <circle cx="100" cy="100" r="20" stroke="rgba(196,181,253,0.8)" strokeWidth="1" fill="rgba(255,255,255,0.06)" />
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        {/* Big title — over mandala */}
        <div style={{ textAlign: "center", padding: "22px 15px 14px" }}>
          {f.title.split("\n").map((line, i) => (
            <div key={i} style={{ color: i === 0 ? "rgba(255,255,255,0.85)" : "#c084fc", fontSize: i === 0 ? "20px" : "28px", fontWeight: 900, lineHeight: 1.05, letterSpacing: i === 0 ? "5px" : "2px", textTransform: "uppercase", textShadow: "0 2px 24px rgba(0,0,0,0.6)" }}>
              {line}
            </div>
          ))}
...
// ── FLYER 3 — Électro (retail sale, électrique, navy) ────────
function FlyerElectro({ f }: { f: typeof flyers[0] }) {
  return (
    <div style={{ aspectRatio: "1/1.41", position: "relative", overflow: "hidden", background: "#030712" }}>
      ...
      {/* SVG: diagonal electric stripe — top right */}
      ...
      {/* SVG: decorative circle — bottom right */}
      <svg style={{ position: "absolute", bottom: "8%", right: "-22%", width: "70%", opacity: 0.05 }} viewBox="0 0 200 200">
        <circle cx="100" cy="100" r="96" stroke="white" strokeWidth="2" fill="none" />
        <circle cx="100" cy="100" r="76" stroke="white" strokeWidth="1" fill="none" />
        <circle cx="100" cy="100" r="56" stroke="white" strokeWidth="0.6" fill="none" />
      </svg>
      ...
      <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "11px 15px 8px", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div style={{ padding: "3px 8px", borderRadius: "4px", background: "#facc15", color: "#030712", fontSize: "7px", fontWeight: 900, letterSpacing: "0.5px" }}>{f.tag.toUpperCase()}</div>
        </div>
        ...
        <div style={{ textAlign: "center", padding: "14px 15px 10px" }}>
          ...
          {f.title.split("\n").map((line, i) => (
            <div key={i} style={{ fontWeight: 900, lineHeight: 1.05, textTransform: "uppercase", fontSize: i === 0 ? "26px" : "22px", color: i === 0 ? "white" : "#facc15", letterSpacing: i === 0 ? "4px" : "2px", textShadow: "0 2px 20px rgba(0,0,0,0.5)" }}>
              {line}
            </div>
          ))}
        </div>
...
function FlyerCard({ f, index }: { f: typeof flyers[0]; index: number }) {
  const preview = index === 0 ? <FlyerRestaurant f={f} /> : index === 1 ? <FlyerPilates f={f} /> : <FlyerElectro f={f} />;
  return (
    <div className="rounded-2xl overflow-hidden border border-gray-100" style={{ background: "white", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
      {preview}
      <div className="px-5 py-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-xs mt-0.5">{f.prints} · Livré en {f.deliveryTime}</p>
        </div>
        <p className="font-black text-base" style={{ color: "#7c3aed" }}>{f.price}</p>
      </div>
    </div>
  );
}

function PricingCard({ p, accent }: { p: { name: string; price: string; period: string; sub: string; features: string[]; highlighted?: boolean }; accent: string }) {
  return (
    <div
      className="rounded-2xl p-6 border flex flex-col gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
      style={p.highlighted
        ? { background: accent, border: `1px solid ${accent}`, boxShadow: `0 8px 32px ${accent}30` }
        : { background: "white", border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}
    >
      <div>
        <p className={`text-xs font-bold uppercase tracking-widest mb-2 ${p.highlighted ? "text-white/70" : "text-gray-400"}`}>{p.name}</p>
        <div className="flex items-baseline gap-1">
          <span className={`font-black leading-none ${p.highlighted ? "text-white" : "text-gray-900"}`} style={{ fontSize: "2rem" }}>{p.price}</span>
          <span className={`text-sm font-medium ${p.highlighted ? "text-white/70" : "text-gray-400"}`}>{p.period}</span>
        </div>
        <p className={`text-xs mt-1.5 ${p.highlighted ? "text-white/70" : "text-gray-400"}`}>{p.sub}</p>
      </div>
      <ul className="flex flex-col gap-2.5 flex-1">
        {p.features.map((f) => (
          <li key={f} className="flex items-start gap-2.5">
            <div className={`w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${p.highlighted ? "bg-white/20" : "bg-purple-50"}`}>
              <Check size={10} className={p.highlighted ? "text-white" : "text-purple-600"} />
            </div>
            <span className={`text-xs leading-relaxed ${p.highlighted ? "text-white/90" : "text-gray-600"}`}>{f}</span>
          </li>
        ))}
      </ul>
      <a
        ...
        className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-sm font-bold transition-all duration-200 ${
          p.highlighted ? "bg-white text-purple-700 hover:bg-white/90" : "border border-gray-200 text-gray-700 hover:border-purple-300 hover:text-purple-700"
        }`}
      >
...
type Tab = "ads" | "sites" | "flyers";

const tabs: { id: Tab; label: string; sub: string }[] = [
  { id: "ads",    label: "Publicités",  sub: "Campagnes Facebook & Google Ads"   },
  { id: "sites",  label: "Sites web",   sub: "Vitrines & boutiques livrées"      },
  { id: "flyers", label: "Flyers",      sub: "Créations print & réseaux sociaux" },
];

export default function Portfolio() {
  const [active, setActive] = useState<Tab>("ads");
  const accent = active === "ads" ? "#7c3aed" : active === "sites" ? "#0284c7" : "#be185d";
  const pricing = active === "ads" ? adsPricing : active === "sites" ? sitesPricing : flyersPricing;

  return (
    <section id="portfolio" className="relative py-24 md:py-32 lg:py-40" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
      <div className="section-container">
        ...
        >
          ...
          <p className="text-gray-500 text-base" style={{ maxWidth: "38rem" }}>
            Voici ce qu&apos;on réalise pour nos clients, avec les résultats et les tarifs transparents. Pas de surprise.
          </p>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {tabs.map((tab) => (
            <button
              ...
              className="flex flex-col items-center px-6 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 border"
              style={
                active === tab.id
                  ? { background: accent, color: "white", border: `1px solid ${accent}`, boxShadow: `0 4px 16px ${accent}30` }
                  : { background: "white", color: "#6b7280", border: "1px solid rgba(0,0,0,0.08)" }
              }
            >
              {tab.label}
              <span className={`text-xs font-normal mt-0.5 ${active === tab.id ? "text-white/70" : "text-gray-400"}`}>
                {tab.sub}
              </span>
            </button>
          ))}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-5 md:gap-6 mb-16">
              {active === "ads"    && adCampaigns.map((c, i) => <AdCard      key={i} c={c} />)}
              {active === "sites"  && websites.map((w, i)     => <WebsiteCard key={i} w={w} />)}
              {active === "flyers" && flyers.map((f, i)        => <FlyerCard   key={i} f={f} index={i} />)}
            </div>

            {/* Pricing */}
            <div>
              <div className="text-center mb-8">
                <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-2">Nos tarifs</h3>
              ...
              <div className="grid md:grid-cols-3 gap-5 md:gap-6">
                {pricing.map((p, i) => (
                  <motion.div key={p.name} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }}>
              ...
              <p className="text-center text-xs text-gray-400 mt-6">
                ...
                <a href="#contact" className="text-purple-700 font-semibold hover:text-purple-800">Demandez un devis sur-mesure →</a>
              </p>
            </div>
          </motion.div>
        </AnimatePresence>
